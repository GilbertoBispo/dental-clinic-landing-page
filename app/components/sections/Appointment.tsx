...
export default function Appointment() {
    return (
        <section className="bg-(--dark) text-(--text) flex flex-col items-center p-5 text-shadow-lg">
            <div className="flex flex-col items-center gap-5">
                <h2 className="text-3xl">Request Your <span className="text-sky-500">Appointment</span></h2>
                <h3 className="font-bold">Ready for a Healthier, Brighter Smile?</h3>
