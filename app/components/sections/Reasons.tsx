...
export default function Reasons() {
    ...
    return(
        <section className="flex items-center gap-5 px-5 overflow-scroll w-full h-fit no-scrollbar">
            {
                ...
                whyChooseUsFeatures.map((features, index) => {
                    ...
                    return (
                        <motion.div className="flex flex-col items-center py-5"
                            key={index}
                            initial={{opacity: 0}}
                            ...
                            <Cards className="flex flex-col p-5 gap-5 text-shadow-lg w-[80vw] h-80 md:w-[45vw]">
