...
export default function Testimonials(){
    ...
    return(
        <section className="flex overflow-scroll h-fit py-5 no-scrollbar relative bg-image bg-repeat bg-cover bg-bottom">
                ...
                return(
                    ...
                    <motion.div
                        ...
                        <Cards className="flex flex-col p-5 gap-5 text-shadow-lg w-[80vw] h-80 mx-5 bg-white/40 backdrop-blur-md z-10 border border-white">
